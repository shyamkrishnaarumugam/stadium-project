        ...
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav" >
            ...
            <Nav className='nav-text'>
              ...
              <Nav.Link href=""><div className='d-flex flex-column justify-content-center text-white'><div className='mx-auto'><FontAwesomeIcon icon={faComments} /></div><div className='mx-auto'>Messages</div></div></Nav.Link>
